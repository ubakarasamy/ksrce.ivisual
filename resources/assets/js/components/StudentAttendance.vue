            ...
            <!-- Form -->
                               ...
                               <div class="row">
                                    <div class="form-group col-md-4">
                                            ...
                                            <input :required="true" type="date" id="date" v-model="createAttendance.makedate" name="date" max="3000-12-31" min="1000-01-01" class="form-control" style="width:200px;">
                                            <p class="text-muted">Please double Check the Date</p>
                                       </div>
                                       <div class="form-group col-md-4">
                                            <label for="eid">Employee ID</label>
                                            <input :required="true" :disabled="true" type="text" id="eid" v-model="createAttendance.staff_eid" name="eid" class="form-control">
                                            <p class="text-muted">Your Employee Id</p>
                                       </div>
                                       <div class="form-group col-md-4">
                                            <label for="eid">Day</label>
                                            <select :required="true" class="form-control" style="width:100px;" name="day" id="day" v-model="createAttendance.day">
...
export default {
  data() {
    return {
      ...
      createAttendance: {
        makedate: "",
        staff_eid: this.authenticateduser.eid,
        day:""
      },
      attendanceDatas: [],
      createForm: true,
