    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <table class="table" style="text-transform:uppercase;">
         ...
         <a class="btn btn-outline-primary" :href="staff.profile_url" >Profile Pdf</a>
      </div>
    </div>
  </div>
</div>
...
<div class="form-group">
    ...
    <small class="text-muted">Eg: ubakarasamy.sm</small>
  </div>
  <div class="form-group">
...
<div class="form-group">
    <label for="Staffurlcreate">Profile Url</label>
    <input type="text" class="form-control" id="Staffurlcreate" aria-describedby="StaffurlHelp" placeholder="Enter Name" v-model="staff.profile_url">
    <small class="text-muted">Eg: ubakarasamy.sm</small>
  </div>
...
<div class="filter-options staffprofile-tab-head">
  <div class="row">
    <div class="col-sm-6">
      <div class="form-group">
  <input v-model="searchFrm" placeholder="Name or EID" type="text" style="width:250px;" class="form-control mt-1">
</div>
    </div>
    <div class="col-sm-6">
...
export default {
  ...
  methods: {
    ...
    handleFileUpload(e) {
      ...
      // fileReader.onload = (e) => {
      //   this.staff.pic = e.target.result;
      // }

      // console.log(this.staff.pic);
    },
    checkForm: function() {
    ...
    editStaff(staff) {
      ...
      this.staff.eid = staff.eid;
       this.staff.profile_url = staff.profile_url;
    },
    viewStaff(staff) {
      this.staff.id = staff.id;
      this.staff.user_id = staff.id;
  ...
  computed: {
    filteredItems: function() {
      ...
      if (department === "all" && occupation === "all" && search === "") {
        ...
        return vm.staffs.filter(function(staff) {
          ...
          return (
            ...
            (occupation === "all" || staff.occupation === occupation) &&
            (staff.name.toLowerCase().includes(search.toLowerCase()) ||
              staff.eid.toLowerCase().includes(search.toLowerCase()))
          );
        });
      }
    }
