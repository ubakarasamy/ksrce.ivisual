      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle"> 
            <span class="text-muted" style="text-transform:uppercase;">
                {{allTimetable.degree}} 
                {{allTimetable.department}}
                {{allTimetable.year}}Year
                {{allTimetable.semester}} Sem
                {{allTimetable.section}} Section
            </span>  
                </h5>
...
<select :disabled="userrole > 2" class="form-control" id="student_degree_filter" style="width:120px;display:inline-block;" v-model="degreeSelected">
...
<form @submit.prevent="createTimeTable()">
            <table class="table table-responsive input-table" style="text-transform:uppercase;">
                ...
                <tbody>
                    <tr>
                        <td><strong>Mon</strong> </td>
                        <td><input :required="true"  v-model="timeTables.mon1" type="text" name="mon1" id="mon1" placeholder="Mon 1"></td>
                        <td><input :required="true"  v-model="timeTables.mon2" type="text" name="mon2" id="mon2" placeholder="Mon 2"></td>
                        <td><input :required="true"  v-model="timeTables.mon3" type="text" name="mon3" id="mon3" placeholder="Mon 3"></td>
                        <td><input :required="true"  v-model="timeTables.mon4" type="text" name="mon4" id="mon4" placeholder="Mon 4"></td>
                        <td><input :required="true"  v-model="timeTables.mon5" type="text" name="mon5" id="mon5" placeholder="Mon 5"></td>
                        <td><input :required="true"  v-model="timeTables.mon6" type="text" name="mon6" id="mon6" placeholder="Mon 6"></td>
                        <td><input :required="true"  v-model="timeTables.mon7" type="text" name="mon7" id="mon7" placeholder="Mon 7"></td>
                    </tr>
                    <tr>
                        <td><strong>Thu</strong> </td>
                        <td><input :required="true"  v-model="timeTables.tue1" type="text" name="tue1" id="tue1" placeholder="Thu 1"></td>
                        <td><input :required="true"  v-model="timeTables.tue2" type="text" name="tue2" id="tue2" placeholder="Thu 2"></td>
                        <td><input :required="true"  v-model="timeTables.tue3" type="text" name="tue3" id="tue3" placeholder="Thu 3"></td>
                        <td><input :required="true"  v-model="timeTables.tue4" type="text" name="tue4" id="tue4" placeholder="Thu 4"></td>
                        <td><input :required="true"  v-model="timeTables.tue5" type="text" name="tue5" id="tue5" placeholder="Thu 5"></td>
                        <td><input :required="true"  v-model="timeTables.tue6" type="text" name="tue6" id="tue6" placeholder="Thu 6"></td>
                        <td><input :required="true"  v-model="timeTables.tue7" type="text" name="tue7" id="tue7" placeholder="Thu 7"></td>
                    </tr>
                    <tr>
                        <td><strong>Wed</strong> </td>
                        <td><input :required="true"  v-model="timeTables.wed1" type="text" name="wed1" id="wed1" placeholder="Wed 1"></td>
                        <td><input :required="true"  v-model="timeTables.wed2" type="text" name="wed2" id="wed2" placeholder="Wed 2"></td>
                        <td><input :required="true"  v-model="timeTables.wed3" type="text" name="wed3" id="wed3" placeholder="Wed 3"></td>
                        <td><input :required="true"  v-model="timeTables.wed4" type="text" name="wed4" id="wed4" placeholder="Wed 4"></td>
                        <td><input :required="true"  v-model="timeTables.wed5" type="text" name="wed5" id="wed5" placeholder="Wed 5"></td>
                        <td><input :required="true"  v-model="timeTables.wed6" type="text" name="wed6" id="wed6" placeholder="Wed 6"></td>
                        <td><input :required="true"  v-model="timeTables.wed7" type="text" name="wed7" id="wed7" placeholder="Wed 7"></td>
                    </tr>
                    <tr>
                        <td><strong>Thu</strong> </td>
                        <td><input :required="true"  v-model="timeTables.thu1" type="text" name="thu1" id="thu1" placeholder="Thu 1"></td>
                        <td><input :required="true"  v-model="timeTables.thu2" type="text" name="thu2" id="thu2" placeholder="Thu 2"></td>
                        <td><input :required="true"  v-model="timeTables.thu3" type="text" name="thu3" id="thu3" placeholder="Thu 3"></td>
                        <td><input :required="true"  v-model="timeTables.thu4" type="text" name="thu4" id="thu4" placeholder="Thu 4"></td>
                        <td><input :required="true"  v-model="timeTables.thu5" type="text" name="thu5" id="thu5" placeholder="Thu 5"></td>
                        <td><input :required="true"  v-model="timeTables.thu6" type="text" name="thu6" id="thu6" placeholder="Thu 6"></td>
                        <td><input :required="true"  v-model="timeTables.thu7" type="text" name="thu7" id="thu7" placeholder="Thu 7"></td>
                    </tr>
                    <tr>
                        <td><strong>Fri</strong> </td>
                        <td><input :required="true"  v-model="timeTables.fri1" type="text" name="fri1" id="fri1" placeholder="Fri 1"></td>
                        <td><input :required="true"  v-model="timeTables.fri2" type="text" name="fri2" id="fri2" placeholder="Fri 2"></td>
                        <td><input :required="true"  v-model="timeTables.fri3" type="text" name="fri3" id="fri3" placeholder="Fri 3"></td>
                        <td><input :required="true"  v-model="timeTables.fri4" type="text" name="fri4" id="fri4" placeholder="Fri 4"></td>
                        <td><input :required="true"  v-model="timeTables.fri5" type="text" name="fri5" id="fri5" placeholder="Fri 5"></td>
                        <td><input :required="true"  v-model="timeTables.fri6" type="text" name="fri6" id="fri6" placeholder="Fri 6"></td>
                        <td><input :required="true"  v-model="timeTables.fri7" type="text" name="fri7" id="fri7" placeholder="Fri 7"></td>
                    </tr>
                </tbody>
            </table>
<p class="text-info">please double check before you submit</p>
