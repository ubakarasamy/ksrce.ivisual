...
<table class="table">
    ...
    <tbody>
        <tr v-for="stud in filteredStudents" v-bind:key="stud.id">
            ...
            <td>
              <button type="button" @click="GetOverallByStudId(stud)" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#exampleModalCenter">
  View
</button>
<!-- Modal -->
