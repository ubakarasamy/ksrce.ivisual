...
Vue.component('staffattendance-byday', require('./components/StaffAttendance-byday.vue'));
Vue.component('staffattendance-byoverall', require('./components/StaffAttendance-byoverall.vue'));
